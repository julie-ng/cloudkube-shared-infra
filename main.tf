...
module "cloudkube" {
  ...
  tls_certificates = {
    dev = {
      root = {
        name      = "dev-cloudkube"
        cert_path = "./certs/2022/combined_dev_cloudkube_io.pem"
      }
      wildcard = {
        name      = "wildcard-dev-cloudkube"
        cert_path = "./certs/2022/combined_star_dev_cloudkube_io.pem"
      }
    }
    ...
    staging = {
      root = {
        ...
        cert_path = "./certs/2022/combined_staging_cloudkube_io.pem"
      }

      wildcard = {
        name      = "wildcard-staging-cloudkube"
        cert_path = "./certs/2022/combined_star_staging_cloudkube_io.pem"
      }
    }
    ...
    prod = {
      root = {
        name      = "cloudkube"
        cert_path = "./certs/2022/combined_cloudkube_io.pem"
      }
      wildcard = {
        name      = "wildcard-cloudkube"
        cert_path = "./certs/2022/combined_star_cloudkube_io.pem"
      }
    }
  }
